# 🏢 OWLBAN GROUP LEEPYEAR 1 LLC

## Entity Overview

**OWLBAN GROUP LEEPYEAR 1 LLC** is the primary operational entity within the OWLBAN GROUP corporate structure. This LLC serves as the main revenue-generating and business operations vehicle.
...
LEEPYEAR 1 LLC operates as the primary business entity for:

- **Core Business Operations**: Day-to-day business activities and revenue generation
- **Client Services**: Direct client engagement and service delivery
- **Asset Management**: Management of operational assets and resources
- **Contract Execution**: Primary entity for business contracts and agreements
- **Employment**: Employer of record for staff and contractors
...
### Ownership Structure
- **Parent Company**: OWLBAN GROUP HOLDINGS CORPORATION (100% ownership)
- **Ownership Type**: Single-member LLC (owned by C Corporation)

### Management Structure
- **Management Type**: Manager-Managed
- **Managing Member**: Lativia Gibbs
- **Operations Manager**: Oscar Broome
- **Financial Officer**: David Leeper
...
1. **Primary Operations**
   - [Describe main business activities]
   - [Service offerings]
   - [Product lines]
...
- **Additional Locations**: [Addresses if applicable]
- **Remote Operations**: [Yes/No - Details]
...
- [x] State Registration Certificate
...
- **OWLBAN GROUP HOLDINGS CORPORATION**
  ...
  - Management Services Agreement: [Yes/No]

### Sister Companies (C Corp Shells)
- **Shell Company 1**: [Relationship/Agreements]
- **Shell Company 2**: [Relationship/Agreements]
- **Shell Company 3**: [Relationship/Agreements]

### Trust Relationships
- **Business Asset Protection Trust**: [Asset holdings/relationships]
...
### Annual Requirements
- [ ] State Annual Report - Due: [MM/DD]
- [ ] Federal Tax Return (Form 1065) - Due: 03/15
- [ ] State Tax Return - Due: [MM/DD]
- [ ] Business License Renewal - Due: [MM/DD]
...
- **Full-Time**: [Number]
- **Part-Time**: [Number]
- **Payroll Provider**: [Provider Name]

### Independent Contractors
- **Active Contractors**: [Number]
- **1099 Filing Requirement**: Yes
...
- **Primary**: [Location/Safe/Office]
- **Backup**: [Location]

### Digital Documents Location
- **Cloud Storage**: [Service/Location]
...
### Authorized Signers
1. Lativia Gibbs - Managing Member
2. David Leeper - Financial Officer
3. Oscar Broome - Operations Manager

### Document Access
- **Level 1 (Full Access)**: Managing Member, Corporate Officers
- **Level 2 (Financial Access)**: Financial Officer, CPA
- **Level 3 (Operational Access)**: Operations Manager
- **Level 4 (Limited Access)**: [Other authorized personnel]
