...
## Deployment Steps
- [ ] Create a Dockerfile for Grafana with dashboard.json copied inside
- [ ] Update docker-compose.yml for production build
- [ ] Build the Docker image
- [ ] Push the image to Docker Hub
- [ ] Deploy to Heroku (or chosen cloud platform)
